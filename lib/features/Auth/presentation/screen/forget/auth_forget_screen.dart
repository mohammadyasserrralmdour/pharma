      ...
      body: Stack(
        children: [
          AuthHeadScreenWidget(
            dataAuthHeadScreen: listdataAuthHeadScreen["forget"],
          ),
          Positioned(
              top: begainScreen,
              left: 0,
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                  ...
                  const SizedBox(height: 30, child: AuthTimer()),
                    ...
                    children: [
                      TextButton(
                        onPressed: () => GoRouter.of(context)
                            .go(AppRoutes.forgetPasswordScreen),
                        child: Text(
                          "resend code",
                          style: TextStyle(
                  ...
                  PrimaryButton(
                      ...
                      onPressed: () {
                        GoRouter.of(context)
                            .pushReplacement(AppRoutes.authResetScreen);
                      }),
                ])),
              )),
        ],
