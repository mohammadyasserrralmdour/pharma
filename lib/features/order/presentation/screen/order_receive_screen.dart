        ...
        child: Column(
          children: [
            PrimaryAppbar(
              ...
              title: "Receive Order",
              firstfunction: () =>
                  GoRouter.of(context).push(AppRoutes.orderReposatoryScreen),
                  firstIcon: Icons.scanner,
                  secondIcon: Icons.bookmark_border_rounded,
            ),
           const OrderSpeceification(repository: "data", status: "data", price: "data"),
              verticalSpace(5),
            const PharmacyTextTitleBlue(text: "Drugs"),
             const Expanded(
                child: SizedBox(
              child: PharmacyListDrugs(drugsShowType: DrugsShowType.toReceiveOrder,),
            )),
          ],
        ),
      ),
